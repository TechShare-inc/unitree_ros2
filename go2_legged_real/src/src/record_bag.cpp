/**
 * This example demonstrates how to use ROS2 to record motion states of unitree go2 robot
 **/
...
public:
    motion_state_suber() : Node("motion_state_suber")
    {
        ...
        writer_->create_topic(
            {"a",
             "unitree_go/msg/sport_mode_state",
             rmw_get_serialization_format(),
             ""});
...
private:
    ...
    unitree_go::msg::SportModeState state_data; // Unitree sportmode state message
};
